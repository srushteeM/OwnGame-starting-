...
function draw(){
    ...
    if(gameState==="STORY"){
        ...
        textSize(30)
        text("YOU ARE THE HERO OF YOUR CITY",200,30);
        text("BUT YOUR CITY IS IN DANGER" ,200,70);
        text("ALIENS HAVE INVADED YOUR CITY ",200,110);
        text("YOUR ARE THE LAST HOPE OF YOUR CITY",200,150);
        text("SAVE YOUR CITY BY KILLING ALL ALIENS" ,200,190);
        text("YOUR ABILITY INCREASES AS YOU KILL YOUR ENEMIES",200,230);

        text("GOOD LUCK",displayWidth/2-200,displayHeight-170); 
        text("PRESS A TO START THE GAME",displayWidth-1140,displayHeight-120);
